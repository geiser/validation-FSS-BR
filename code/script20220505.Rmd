...
```{r structure4longFSS, fig.width=12, fig.height=12, dpi=600}
library(semPlot)
semPlot::semPaths(
...
```{r structure4secondLongFSS, fig.width=12, fig.height=8, dpi=600}
library(semPlot)
semPlot::semPaths(
...
```{r irt4longFSS2infotrace, dpi=600}
plot(mirt4mult, type='infotrace')
```

```{r irt4longFSS2info, dpi=600}
plot(mirt4mult, type='info')
```

```{r irt4longFSS2infoSE, dpi=600}
...
```{r structure4originalShortFSS, fig.width=12, fig.height=12, dpi=600}
library(semPlot)
semPlot::semPaths(
...
```{r structure4altShortFSS, fig.width=12, fig.height=12, dpi=600}
library(semPlot)
semPlot::semPaths(
...
```{r irt4shortFSS2infotrace, dpi=600}
plot(mirt4alt, type='infotrace')
```

```{r irt4shortFSS2info, dpi=600}
plot(mirt4alt, type='info')
```

```{r irt4shortFSS2infoSE, dpi=600}
