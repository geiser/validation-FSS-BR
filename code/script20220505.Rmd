...
```{r fig4multi, fig.width=12, fig.height=12}
library(semPlot)
semPlot::semPaths(
...
```{r fig4second, fig.width=12, fig.height=8}
library(semPlot)
semPlot::semPaths(
...
```{r fig4multi31, fig.width=12, fig.height=12}
library(semPlot)
semPlot::semPaths(
  fit4multi, "std", curvePivot = T, layout = "circle", rotation = 3,
  fade = T, intercepts = T, residuals = T, sizeLat = 4, sizeLat2 = 3, sizeMan = 4,
...
```{r fig4second31, fig.width=12, fig.height=8}
library(semPlot)
semPlot::semPaths(
...
```{r fig4uni, fig.width=12, fig.height=12}
library(semPlot)
semPlot::semPaths(
...
```{r fig4alt, fig.width=12, fig.height=12}
library(semPlot)
semPlot::semPaths(
