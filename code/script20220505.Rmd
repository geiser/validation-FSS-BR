...
```{r structure4longFSS, fig.width=8, fig.height=8, dpi=300}
library(semPlot)
semPlot::semPaths(
...
```{r structure4secondLongFSS, fig.width=8, fig.height=6, dpi=300}
library(semPlot)
semPlot::semPaths(
...
```{r structure4altShortFSS, fig.width=12, fig.height=12, dpi=300}
library(semPlot)
semPlot::semPaths(
...
```{r irt4shortFSS2infotrace, dpi=300}
plot(mirt4alt, type='infotrace')
```

```{r irt4shortFSS2info, dpi=300}
plot(mirt4alt, type='info')
```

```{r irt4shortFSS2infoSE, dpi=300}
